        ...
        <div className="container text-white">
          <div className="row hero">
            <div className="col-12 col-md-12 col-lg-7">
              <div className="div-1">
                <h4 className='text-dark mt-5'>Welcome to Doc's Valley</h4>
                <h1>Global Health-Care Market Place</h1>
                <p>Welcome to Doc's Valley, your ultimate destination for health and wellness guidance. At Doc's Valley, we strive to provide you with comprehensive and reliable information to empower you on your journey towards a healthier lifestyle. Whether you're seeking expert advice on wellness.</p>
