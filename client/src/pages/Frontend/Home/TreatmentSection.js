                ...
                <div className="container mt-5 my-4">
                    <div className="row justify-content-center">
                        <div className="col-12 col-md-8 col-lg-8 text-center">
                            ...
                            <p className='w-75 '> From cutting-edge advancements in oncology to innovative therapies in neurology and beyond, our platform offers a comprehensive spectrum of treatments across various medical specialities, ensuring personalized care tailored to your unique health requirements.</p>
                        </div>
                    </div>
                </div>
