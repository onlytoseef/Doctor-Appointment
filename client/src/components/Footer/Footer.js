        ...
        <>
            <div className="container">
                <footer className="row flex-wrap-reverse pt-5 my-5">
                    ...
                    <div className="d-flex flex-wrap justify-content-between col-12 col-md-6 col-gl-6">
                        ...
                        <div className="col-12 col-md-2 col-gl-2 mb-3">
                            <h5>CONTACT</h5>
                            <ul className="nav flex-column">
                                <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-body-secondary">(+92)300-0261265</a></li>
                                <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-body-secondary">mhuzaifarauf13@gmail.com</a></li>
                ...
                <div className="row footer border-top">
                    <div className="col">
                        <p>Copyright © {date} Doc's Valley. All rights reserved.</p>
                    </div>
                    <div className="col ">
